...
np.savetxt(save_dir + '/' + modelName + '_train_predictions.csv', predictions, delimiter=";")
np.savetxt(save_dir + '/' + modelName + '_test_filenames.csv', test_generator.filenames, delimiter =";", fmt = '% s')
np.savetxt(save_dir + '/' + modelName + '_test_classes.csv', test_generator.classes, delimiter=";")
np.savetxt(save_dir + '/' + modelName + '_classnames.csv', target_names.sort(), delimiter=";", fmt = '% s')
...
zipObj.write(save_dir + '/' + modelName + '_train_predictions.csv', basename(save_dir + '/' + modelName + '_train_predictions.csv'))
